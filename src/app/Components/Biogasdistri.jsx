...
const Biogasdistri = () => {
  return (
    <div className="bg-white py-10 sm:py-16 px-4 sm:px-6 lg:px-8 overflow-x-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 relative">
          ...
          <div className="relative text-center py-4 sm:py-8 rounded-2xl w-full max-w-[800px] mx-auto px-4">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-green-800 break-words">
              Compressed Biogas{" "}
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl">
              <img
                ...
                className="w-full h-56 sm:h-72 md:h-96 lg:h-72 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
              <div className="absolute bottom-6 left-6 right-6 text-white">
                <h3 className="text-lg sm:text-xl font-bold break-words">Modern CBG Facility</h3>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 shadow-lg">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                <div className="w-3 h-3 bg-blue-800 rounded-full shrink-0"></div>
                <span className="min-w-0">Vertical Overview</span>
              </h3>
            ...
            <div className="bg-white border-2 border-blue-100 rounded-2xl p-6 sm:p-8 shadow-lg">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                ...
                <span className="min-w-0">Key Offerings</span>
              </h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-800 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="min-w-0 text-gray-700 font-medium text-sm sm:text-base">Household & industrial biogas supply</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-800 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="min-w-0 text-gray-700 font-medium text-sm sm:text-base">CBG plant installation & franchising model</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-800 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="min-w-0 text-gray-700 font-medium text-sm sm:text-base">Biogas cylinders distribution network</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-800 rounded-full mt-2 flex-shrink-0"></div>
                  <p className="min-w-0 text-gray-700 font-medium text-sm sm:text-base">Waste-to-energy ecosystem in villages</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
              <div className="bg-gradient-to-br from-green-700 to-green-800 rounded-2xl p-6 text-white shadow-xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="min-w-0 text-base sm:text-lg md:text-xl font-bold">Feedstock Collection & Segregation</h3>
                </div>
              ...
              <div className="bg-white rounded-2xl p-6 text-black shadow-xl border border-gray-100">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-[#205D34] rounded-full flex items-center justify-center flex-shrink-0">
                    <span className="text-white font-bold text-lg">2</span>
                  </div>
                  <h3 className="min-w-0 text-base sm:text-lg md:text-xl font-bold">Biogas Generation</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-green-700 to-green-800 rounded-2xl p-6 text-white shadow-xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="min-w-0 text-base sm:text-lg md:text-xl font-bold">Bottling & Purification</h3>
                </div>
                <div className="space-y-3 text-green-50">
                  <div>
                    <p className="font-semibold text-sm mb-1">Activity:</p>
              ...
              <div className="bg-white rounded-2xl p-6 text-black shadow-xl border border-gray-100">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="min-w-0 text-base sm:text-lg md:text-xl font-bold">Distribution & Sales</h3>
                </div>

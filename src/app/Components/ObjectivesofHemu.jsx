          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-2 leading-tight break-words">
                  STRATEGIC<br />
                  <span className="text-yellow-200">OBJECTIVES</span><br />
                  <span className="text-2xl sm:text-3xl md:text-4xl">OF HEMU</span>
                </h1>
